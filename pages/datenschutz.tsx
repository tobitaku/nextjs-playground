...
const PrivacyPolicy = () => (
  <StaticPageLayout>
    <Head title="Tobias Ziegler | Datenschutzerklärung" noindex />
    <StaticPageHeadline variant="h1">
    ...
    <StaticPageSection>
      ...
      <StaticPageHeadline variant="h3">Allgemeine Hinweise</StaticPageHeadline>{' '}
      <p>
      ...
      <StaticPageHeadline variant="h3">
        Datenerfassung auf dieser Website
      </StaticPageHeadline>{' '}
      <StaticPageHeadline variant="h4">
    ...
    <StaticPageSection>
      <StaticPageHeadline variant="h2">2. Hosting</StaticPageHeadline>
      <p>
        Wir hosten die Inhalte unserer Website bei folgendem Anbieter: Netlify,
        Inc.
      </p>
      <StaticPageHeadline variant="h3">Externes Hosting</StaticPageHeadline>{' '}
      <p>
    ...
    <StaticPageSection>
      ...
      <StaticPageHeadline variant="h3">Datenschutz</StaticPageHeadline>{' '}
      <p>
      ...
      <p>
        Tobias Ziegler
        <br />
        Simon-Sch&ouml;ffel-Stra&szlig;e 12
      </p>
      <p>
        Telefon: +49 151 42345482
        <br />
        E-Mail: me@tobiasziegler.dev
      </p>
      <p>
      ...
      <StaticPageHeadline variant="h3">Speicherdauer</StaticPageHeadline>{' '}
      <p>
